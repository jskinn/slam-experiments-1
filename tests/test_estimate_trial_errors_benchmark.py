...
import estimate_trial_errors_benchmark as eeb
...
class MockTrialResult(arvet.core.trial_result.TrialResult):
    ...
    def __init__(self, gt_trajectory, comp_trajectory, has_scale, system_id):
        super().__init__(
            system_id=system_id,
            success=True,
            system_settings={},
...
class TestEstimateErrorsBenchmark(arvet.database.tests.test_entity.EntityContract, unittest.TestCase):
    ...
    def get_class(self):
        return eeb.EstimateTrialErrorsBenchmark

    def make_instance(self, *args, **kwargs):
        return eeb.EstimateTrialErrorsBenchmark(*args, **kwargs)
    ...
    def assert_models_equal(self, benchmark1, benchmark2):
        ...
        :return:
        """
        if (not isinstance(benchmark1, eeb.EstimateTrialErrorsBenchmark) or
                not isinstance(benchmark2, eeb.EstimateTrialErrorsBenchmark)):
            self.fail('object was not a EstimateTrialErrorsBenchmark')
...
class TestEstimateErrorsResult(arvet.database.tests.test_entity.EntityContract, unittest.TestCase):
    ...
    def get_class(self):
        return eeb.EstimateTrialErrorsResult
    ...
    def assert_models_equal(self, benchmark_result1, benchmark_result2):
        ...
        :return:
        """
        if (not isinstance(benchmark_result1, eeb.EstimateTrialErrorsResult) or
                not isinstance(benchmark_result2, eeb.EstimateTrialErrorsResult)):
        ...
        self.assertNPEqual(benchmark_result1.errors_by_trial, benchmark_result2.errors_by_trial)
    ...
    def assert_serialized_equal(self, s_model1, s_model2):
        ...
        for key in s_model1.keys():
            if key is not 'estimate_errors' 'trial_results':
