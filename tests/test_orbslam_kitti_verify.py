...
import orbslam_kitti_verify as kitti_verify


class TestOrbslamKITTIVerify(entity_test.EntityContract, unittest.TestCase):

    def get_class(self):
        return kitti_verify.OrbslamKITTIVerify
    ...
    def assert_models_equal(self, experiment1, experiment2):
        ...
        :return:
        """
        if not isinstance(experiment1, kitti_verify.OrbslamKITTIVerify) or \
                not isinstance(experiment2, kitti_verify.OrbslamKITTIVerify):
